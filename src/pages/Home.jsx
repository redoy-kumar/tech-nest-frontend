            ...
            {loading ? (
                ...
                <div className='flex items-center gap-6 justify-start overflow-x-scroll scrollbar-none'>
                    {categoryProduct.map((product, index) => (
                        ...
                        >
                            <div className='h-16 w-16 md:w-24 md:h-24 p-3 rounded-full overflow-hidden bg-gradient-to-br from-white to-gray-100 flex items-center justify-center customShadow'>
                                <img
